                            ...
                            <div class="table-responsive">
                                <table id="table_sales_show" class="table table-bordered table-hover w-100">
                                    ...
                                    <tfoot>
                                        ...
                                        <th colspan="3"></th>
                                        <th><h4 class="text-center" id="total">$ {{ $sale->total }}</h4></th>
                                    </tfoot>
                                </table>
                            </div>
                        </div>
