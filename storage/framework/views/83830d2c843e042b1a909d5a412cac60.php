                                        ...
                                        <td>
                                            <?php if($product->image): ?>
                                                <a href="#" data-toggle="modal" data-target="#imageProductModal<?php echo e($product->id); ?>">
                                                    <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" height="70px" width="70px" class="img-thumbnail">
                                                </a>
                                            <?php endif; ?>
                                        </td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pos-demo/htdocs/www.pos-demo.store/resources/views/depot/products/index.blade.php ENDPATH**/ ?>