                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <form action="<?php echo e(route('clients.index')); ?>" method="GET">
                                    <div class="input-group mb-6">
                                        ...
                                        <input type="text" class="form-control" name="searchText" placeholder="Search clients" value="<?php echo e($searchText); ?>" aria-label="Recipient's username" aria-describedby="button-addon2">
                            ...
                            <div class="col-md-4 d-flex justify-content-end">
                                ...
                                <div class="btn-group btn-sm align-middle">
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Export Clients')): ?>
                                    <form action="<?php echo e(route( 'export.csv', ['table_name' => 'clients'] )); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <button class="btn btn-secondary" type="submit" title="Export to CSV">CSV</button>
                                    </form>
                                    <form action="<?php echo e(route( 'export.excel', ['table_name' => 'clients'] )); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                        <button class="btn btn-secondary" type="submit" title="Export to Excel">Excel</button>
                                    </form>
                                    <form action="<?php echo e(route( 'export.pdf', ['table_name' => 'clients'] )); ?>" method="POST">
                                        <?php echo csrf_field(); ?>
                                ...
                                <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td class="btn-group btn-sm align-items-center">
                                            ...
                                            <button type="button" class="btn btn-outline-warning btn-sm editClient" data-toggle="modal" data-target="#modalEdit<?php echo e($client->id); ?>" title="Update Client">
                                                <i class="fas fa-pen"></i>
                                            </button>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Delete Clients')): ?>
                                            <!-- Button trigger for danger theme modal -->
                                            <button type="button" class="btn btn-outline-danger btn-sm" data-toggle="modal" data-target="#modalDelete<?php echo e($client->id); ?>" title="Delete Client">
                                                <i class="fas fa-trash-alt"></i>
                                            </button>
                                            <?php endif; ?>
                                            <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('Edit Clients')): ?>
                                            <form id="switchForm<?php echo e($client->id); ?>" action="<?php echo e(route('clients.toggle', $client)); ?>" method="POST" class="form">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
                                                <input type="hidden" name="page" value="<?php echo e($clients->currentPage()); ?>">
                                                <div class="custom-control cursor-pointer custom-switch custom-switch-off-danger custom-switch-on-success ml-2" title="Enable/disable Client">
                                                    <input type="checkbox" name="disable-client" class="custom-control-input switch-trigger" id="customSwitch<?php echo e($client->id); ?>" data-clientid="<?php echo e($client->id); ?>" <?php echo e($client->status == 1 ? 'checked' : ''); ?>>
                                                    <label class="custom-control-label" for="customSwitch<?php echo e($client->id); ?>"></label>
                                                </div>
                                            </form>
                                            <?php endif; ?>
                                        ...
                                        <td><?php echo e($client->id_type); ?></td>
                                        <td><?php echo e($client->id_number); ?></td>
                                        <td><?php echo e($client->address); ?></td>
                                        <td><?php echo e($client->phone); ?></td>
                                        <td><?php echo e($client->email); ?></td>
                                    </tr>
                                    <?php echo $__env->make('sales.clients.modals', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </tbody>
                        </table>
...
<div class="modal fade" id="modalCreate" tabindex="-1" role="dialog" aria-labelledby="modalCreateLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo e(route('clients.store')); ?>" method="POST" class="form">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/pos-demo-admin/htdocs/www.pos-demo.online/resources/views/sales/clients/index.blade.php ENDPATH**/ ?>