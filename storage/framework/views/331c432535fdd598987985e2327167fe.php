            ...
            <form action="<?php echo e(route('products.update', $product)); ?>" method="POST" enctype="multipart/form-data" class="form">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <img src="<?php echo e(asset('storage/' . $product->image)); ?>" alt="<?php echo e($product->name); ?>" class="img-thumbnail" id="currentImage" style="max-width: 200px;">
                    </div>
                    <?php endif; ?>
                    <div class="form-group">
...
<?php if($product->image): ?>
    <div class="modal fade" id="imageProductModal<?php echo e($product->id); ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <img id="modalImage" src="<?php echo e(asset('storage/' . $product->image)); ?>"  class="img-fluid">
                </div>
            </div>
        </div>
    </div>
<?php endif; ?><?php /**PATH /home/pos-demo/htdocs/www.pos-demo.store/resources/views/depot/products/modals.blade.php ENDPATH**/ ?>